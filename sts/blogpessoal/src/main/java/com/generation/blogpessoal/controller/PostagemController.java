...
@CrossOrigin(origins = "*", allowedHeaders = "*") // Configura a comunicação entre o Front e o Backend que podem estar
...
public class PostagemController {
	...
	public ResponseEntity<?> deletePostagem(@PathVariable Long id) {
		...
		throw new ResponseStatusException(HttpStatus.NOT_FOUND, "O Id inserido não corresponde a nenhuma postagem!");
	}
