...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		assertEquals(corpoResposta.getBody().getNome(), corpoResposta.getBody().getNome());
		assertEquals(corpoResposta.getBody().getUsuario(), corpoResposta.getBody().getUsuario());
	}
